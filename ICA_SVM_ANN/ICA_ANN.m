...
threshold = 0.99;% Threshold for selection of principal components
...
hiddenLayerSize = round(2*size(dataICA,2));
...
% Train the Network
[net,tr] = train(net,dataICA(train_idx,:)',label(train_idx,:)');
